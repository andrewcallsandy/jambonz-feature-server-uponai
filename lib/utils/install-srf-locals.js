...
const applyFsmrfEslTimeoutPatch = require('./patch-fsmrf-esl-timeout');
const applySrfReinviteCounterPatch = require('./patch-srf-reinvite-counter');
...
function installSrfLocals(srf, logger, {
  ...
  /* bound the ESL api path before any endpoint can be created */
  applyFsmrfEslTimeoutPatch(logger);

  /* release the re-INVITE slot on non-2xx finals, which our own 491s now produce */
  applySrfReinviteCounterPatch(logger);
